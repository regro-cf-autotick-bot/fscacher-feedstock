...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fscacher-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12041&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fscacher-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fscacher` can be installed with:

```
conda install fscacher
```

It is possible to list all of the versions of `fscacher` available on your platform with:
